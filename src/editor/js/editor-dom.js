...
export const applyModeSelect = $('#apply-mode-select');
export const imageProviderSection = $('#image-provider-section');
export const imageProviderSelect = $('#image-provider-select');
