...
test('text engine omits visually hidden content and does not forward slide console output', () => {
  ...
  <p style="position: absolute; top: 100pt; left: 100pt; width: 400pt; overflow: hidden"><span style="display: none">NESTED_DISPLAY_MARKER</span><span style="visibility: hidden">NESTED_VISIBILITY_MARKER</span><span style="opacity: 0">NESTED_OPACITY_MARKER</span><span style="color: rgba(0, 0, 0, 0)">NESTED_TRANSPARENT_MARKER</span><small style="display: none">NESTED_SMALL_MARKER</small><a style="visibility: hidden">NESTED_LINK_MARKER</a></p>
